...
class Loader2(Loader1):
    ...
    def objects(self):
        ...
        obj = line(comp,self.kurse,self.PRICES.pop(),**dd.babelkw('name',de="Erste Schritte",en="First Steps"))
        yield obj
    ...
    - Tipps und Tricks    
    """    
        obj = line(comp,self.kurse,self.PRICES.pop(),description=desc,**dd.babelkw('name',
        ...
        obj = line(sport,self.kurse,self.PRICES.pop(),**dd.babelkw('name',de="Bauchtanz",en="Belly dancing"))
        yield obj
        kw = dict(max_events=8)
        ...
        obj = line(sport,self.kurse,self.PRICES.pop(),**dd.babelkw('name',de="Funktionsgymnastik",en="Functional gymnastics"))
        yield obj
        ...
        obj = line(sport,self.kurse,self.PRICES.pop(),**dd.babelkw('name',de="Rücken fit durch Schwimmen",en="Swimming"))
        yield obj
        ...
        obj = line(sport,self.kurse,self.PRICES.pop(),**dd.babelkw('name',de="Selbstverteidigung im Alltag",en="Self-defence"))
        yield obj
