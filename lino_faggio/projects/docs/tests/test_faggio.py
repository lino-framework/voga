...
Update Guests for Course #1 Calendar entry 1...
0 row(s) have been updated.
Update Guests for Course #1 Calendar entry 2...
0 row(s) have been updated.
Update Guests for Course #1 Calendar entry 3...
0 row(s) have been updated.
Update Guests for Course #1 Calendar entry 4...
0 row(s) have been updated.
Update Guests for Course #1 Calendar entry 5...
0 row(s) have been updated.
...
""")
        ...
        self.assertEqual(res['success'], True)
        expected = """\
Move down for Course #1 Calendar entry 2...
