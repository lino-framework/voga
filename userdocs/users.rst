...
.. _faggio.users.User.profile:

The profile of a user
---------------------

Each user must have a profile in order to be active. 
Users with an empty :ref:`faggio.users.User.profile` 
...
they depend on the :ref:`faggio.users.UserProfile`.
...
The table of available :ref:`faggio.users.Team` records on this site.
...
A membership is when a given :ref:`faggio.users.User` 
belongs to a given :ref:`faggio.users.Team`.



.. _faggio.users.UserProfile:
