...
help_texts = {
    ...
    'lino_voga.lib.courses.desktop.EntriesByCourse' : _("""Shows the events linked to this course."""),
    'lino_voga.lib.courses.desktop.EntriesByCourse.model' : _("""alias of Event"""),
