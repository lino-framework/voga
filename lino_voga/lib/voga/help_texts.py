# -*- coding: UTF-8 -*-
# generated by help_text_builder
from __future__ import unicode_literals
from lino.api import _
help_texts = {
  'lino_voga.projects.roger.lib.courses.models.Course' : _("""Adds two custom print actions."""),
  'lino_voga.lib.courses.models.EnrolmentsAndPaymentsByCourse.master' : _("""alias of Course"""),
  'lino_voga.lib.courses.models.Teacher.teacher_type' : _("""Pointer to TeacherType."""),
  'lino_voga.lib.courses.models.EnrolmentsAndPaymentsByCourse' : _("""Show enrolments of a course together with
invoicing_info and payment_info."""),
  'lino_voga.lib.courses.models.EnrolmentsByCourse' : _("""The Voga version of EnrolmentsByCourse."""),
  'lino_voga.lib.courses.models.Enrolment.payment_info' : _("""A virtual field showing a summary of due accounting movements
(debts and payments)."""),
  'lino_voga.lib.courses.models.EventsByCourse.model' : _("""alias of Event"""),
...
places * fee."""),
  'lino_voga.projects.roger.lib.courses.models.PrintPresenceSheet' : _("""Action to print a presence sheet."""),
  ...
  'lino_voga.lib.courses.models.CoursesByLine' : _("""Like lino_cosi.lib.courses.CoursesByLine, but with other
...
course."""),
  'lino_voga.lib.courses.models.Pupils.model' : _("""alias of Pupil"""),
  ...
  'lino_voga.lib.courses.models.EnrolmentsAndPaymentsByCourse.model' : _("""alias of Enrolment"""),
  'lino_voga.lib.courses.models.EventsByCourse' : _("""Shows the events linked to this course."""),
  'lino_voga.lib.courses.models.EnrolmentsByCourse.model' : _("""alias of Enrolment"""),
  'lino_voga.lib.courses.models.Course.fee' : _("""The default participation fee to apply for new enrolments."""),
  'lino_voga.lib.courses.models.CoursesByTopic' : _("""Shows the courses of a given topic."""),
...
given course."""),
  'lino_voga.lib.courses.models.CoursesByLine.master' : _("""alias of Line"""),
  'lino_voga.lib.courses.models.CourseToXls' : _("""Interesting, but currently not used."""),
  'lino_voga.lib.courses.models.CoursesByTopic.master' : _("""alias of Topic"""),
  'lino_voga.lib.invoicing.models.Plan' : _("""An extended invoicing plan."""),
  'lino_voga.lib.courses.models.CoursesByTopic.model' : _("""alias of Course"""),
  'lino_voga.lib.courses.models.EnrolmentsByCourse.master' : _("""alias of Course"""),
  'lino_voga.lib.courses.models.CoursesByLine.model' : _("""alias of Course"""),
  'lino_voga.lib.courses.models.Pupil' : _("""A pupil is a person with an additional field
pupil_type."""),
  'lino_voga.lib.courses.models.CourseDetail' : _("""The detail layout of a Course (Lino Voga variant)."""),
  'lino_voga.lib.courses.models.Course' : _("""Extends the standard model by adding a field fee."""),
  'lino_voga.lib.courses.models.Pupils' : _("""The global list of all pupils."""),
  'lino_voga.lib.courses.models.StatusReport' : _("""Gives an overview about what's up today ."""),
  'lino_voga.lib.voga.migrate.Migrator' : _("""This class is used because a Lino Voga Site has
